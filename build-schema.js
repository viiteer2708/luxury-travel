...
const BLOG_GUIDES = ['como-planifico-un-gran-viaje', 'viaje-a-medida-que-es', 'checklist-pre-viaje', 'cuanto-cuesta-viaje-a-medida', 'errores-comunes-organizar-viaje', 'itinerario-ritmo-realista', 'jet-lag-cambios-horarios', 'viaje-a-medida-vs-por-tu-cuenta', 'viaje-premium-que-es', 'viajes-pequenos-recuerdos-grandes'];
...
function generate(slug, html) {
  ...
  if (p === '' || p === 'index.html') { out.push(homeOrg()); out.push({ '@context': 'https://schema.org', '@type': 'WebSite', '@id': B.url + '/#website', 'name': B.name, 'url': B.url, 'inLanguage': 'es-ES', 'publisher': { '@id': B.url + '/#organization' } }); const hf = buildHomeFaq(html); if (hf) out.push(hf); }
    ...
    out.push({ '@context': 'https://schema.org', '@type': 'TravelAgency', 'name': 'Horizonte Exclusivo - Agencia de Viajes de Lujo en Molins de Rei', 'url': cu, 'description': pd, 'telephone': B.telephone, 'email': B.email, 'address': { '@type': 'PostalAddress', 'streetAddress': B.street, 'addressLocality': B.city, 'addressRegion': B.region, 'postalCode': B.zip, 'addressCountry': B.country }, 'geo': { '@type': 'GeoCoordinates', 'latitude': B.lat, 'longitude': B.lng }, 'hasMap': 'https://www.google.com/maps?cid=' + B.mapCid, 'areaServed': [{ '@type': 'City', 'name': 'Molins de Rei' }, { '@type': 'AdministrativeArea', 'name': 'Baix Llobregat' }, { '@type': 'City', 'name': 'Sant Feliu de Llobregat' }, { '@type': 'City', 'name': 'Sant Vicenc dels Horts' }, { '@type': 'City', 'name': 'Palleja' }, { '@type': 'City', 'name': 'El Papiol' }, { '@type': 'City', 'name': 'Sant Just Desvern' }, { '@type': 'City', 'name': 'Sant Joan Despi' }, { '@type': 'City', 'name': 'Esplugues de Llobregat' }, { '@type': 'City', 'name': 'Cornella de Llobregat' }, { '@type': 'City', 'name': 'Sant Boi de Llobregat' }, { '@type': 'City', 'name': 'Cervello' }, { '@type': 'City', 'name': 'Corbera de Llobregat' }, { '@type': 'City', 'name': 'Vallirana' }, { '@type': 'City', 'name': 'Torrelles de Llobregat' }, { '@type': 'City', 'name': 'Barcelona' }] });
    out.push(bc([{ name: 'Inicio', url: B.url + '/' }, { name: 'Molins de Rei', url: cu }]));
    // La FAQ local se añadió el 14-ago: son las preguntas que hace quien busca la agencia
    // por el pueblo, y en búsqueda local el FAQPage es de lo poco que ocupa sitio extra en la SERP.
    const faqMolins = buildHomeFaq(html);
    if (faqMolins) out.push(faqMolins);
  }
